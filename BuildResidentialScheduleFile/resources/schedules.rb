...
class ScheduleGenerator
  ...
  def create_stochastic_schedules(args:,
    ...
    @num_occupants = args[:geometry_num_occupants]
  ...
  def _get_ev_battery_schedule(away_schedule, hours_driven_per_year)
    ...
    chunk_counts.each do |is_away, activity_minutes|
      if is_away == 1
        ...
        msg = "activity_minutes = #{activity_minutes}\n"
        msg += "expected_driving_time = #{expected_driving_time}\n"
        msg += "max_driving_time = #{max_driving_time}\n"
        msg += "max_possible_driving_time = #{max_possible_driving_time}\n"
        msg += "actual_driving_time = #{actual_driving_time}\n"
        msg += "driving_minutes_used = #{driving_minutes_used}\n"
